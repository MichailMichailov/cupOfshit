...
<section class="f fac gap8 f_f tab_buttons">
    <button id="tab_1_button" class="btn_tab pad8t pad8b" onclick="showTabAndReload('tab_1', this)">
        <span class="tab_chapter">
            Оформлення
        </span>
        <img class="tab_img" src="<?php echo get_template_directory_uri(); ?>/img/tab1.png" alt="">
    </button>
    <button id="tab_2_button" class="btn_tab pad8t pad8b" onclick="showTabAndReload('tab_2', this)">
            <span class="tab_chapter">
                Піч
            </span>
        <img class="tab_img" src="<?php echo get_template_directory_uri(); ?>/img/tab2.png" alt="">
    </button>
    <button id="tab_3_button" class="btn_tab pad8t pad8b" onclick="showTabAndReload('tab_3', this)">
            <span class="tab_chapter">
                Напівфабрикат
            </span>
        <img class="tab_img" src="<?php echo get_template_directory_uri(); ?>/img/tab3.png" alt="">
    </button>
    <button id="tab_4_button" class="btn_tab pad8t pad8b" onclick="showTabAndReload('tab_4', this)">
            <span class="tab_chapter">
                Поклейка
            </span>
        <img class="tab_img" src="<?php echo get_template_directory_uri(); ?>/img/tab4.png" alt="">
    </button>
    <button id="tab_5_button" class="btn_tab pad8t pad8b" onclick="showTabAndReload('tab_5', this)">
            <span class="tab_chapter">
                Готове
            </span>
        <img class="tab_img" src="<?php echo get_template_directory_uri(); ?>/img/tab5.png" alt="">
    </button>
    <button id="tab_6_button" class="btn_tab pad8t pad8b" onclick="showTabAndReload('tab_6', this)">
            <span class="tab_chapter">
                Звіт
            </span>
        <img class="tab_img" src="<?php echo get_template_directory_uri(); ?>/img/tab6.png" alt="">
    </button>
    <button id="tab_7_button" class="btn_tab pad8t pad8b" onclick="showTabAndReload('tab_7', this)">
            <span class="tab_chapter">
                Редагування
            </span>
    ...
    <script>
        function showTabAndReload(tabId, button) {
            // Ваш код для отображения вкладки
...
<section id="tab_1" class="tabs__block f fc gap60">
    <form id="tab_1_form" class="f fw w gap8 f_f">
        <!--Стекло-->
        <div class="f fc gap8 f_200">
            ...
            <div class="w f fc">
                <input type="text" name="tab_1_glass" list="tab_1_glass" id="tab_1_glass_selected" placeholder="Оберіть скло" class="shadow pad8" required/>
        ...
        <div class="f fc gap8 f_300">
            ...
            <div class="w f fc">
                <input type="text" name="tab_1_insert" list="tab_1_insert" placeholder="Оберіть виїмку" class="shadow pad8"/>
        ...
        <div class="f fc gap8 f_200">
            ...
            <div class="w f fc">
                <input type="text" name="tab_1_master" list="tab_1_master" placeholder="Оберіть фахівця" class="shadow pad8" required/>
    ...
    <div class="f w fw gap20 list_stock">
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук скла" id="search_list_glass" oninput="liveSearch('list_glass', this.value)">
        ...
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук виїмки" id="search_list_insert" oninput="liveSearch('list_insert', this.value)">
    ...
    $insert_list = CFS()->get('insert_list');
        ...
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук вставки" id="search_list_stick" oninput="liveSearch('list_stick', this.value)">
...
<section id="tab_2" class="tabs__block f fc gap60">
    <form id="tab_2_form" class="f fw w gap8 f_f">
        <!--Стекло-->
        <div class="f fc gap8 f_200">
            <div class="w BIG">
                Скло
            ...
            <div class="w f fc">
                <input type="text" name="tab_2_glass" list="tab_2_glass" id="tab_2_glass_selected" placeholder="Оберіть скло" class="shadow pad8" required/>
        ...
        <div class="f fc gap8 f_200">
            ...
            <div class="w f fc">
                <input type="text" name="tab_2_master" list="tab_2_master" placeholder="Оберіть фахівця" class="shadow pad8" required/>
    ...
    <script>
        jQuery(function($) {
            $('.tab_2_buttons button').click(function(e) {
                ...
                var enteredGlass = $('input[name="tab_2_glass"]').val().trim(); // Получаем значение введенного стекла
                ...
                $('datalist#tab_2_glass option').each(function() {
                    ...
                    if (currentGlassName === enteredGlassLower) {
                        isGlassExists = true;
                        return; // Прерываем цикл, так как совпадение найдено
                    }
                });
    ...
    <div class="f w fw gap20 list_stock">
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук скла" id="tab_2_list_search" oninput="liveSearch('tab_2_list', this.value)">
...
<section id="tab_3" class="tabs__block f fc gap60">
    <form id="tab_3_form" class="f fw w gap8 f_f">
        <!--Посуда-->
        <div class="f fc gap8 f_200">
            <div class="w BIG">
                Посуд
            ...
            <div class="w f fc">
                <input type="text" name="tab_3_glass" list="tab_3_glass" id="tab_3_glass_selected" placeholder="Оберіть посуд" class="shadow pad8" required/>
        ...
        <div class="f fc gap8 f_200">
            ...
            <div class="w f fc">
                <input type="text" name="tab_3_master" list="tab_3_master" placeholder="Оберіть фахівця" class="shadow pad8" required/>
            ...
            <div class="f fw gap20 f_f f_512">
                <div class="f gap8 fac shadow pad4 _br8 f_250">
                    ...
                    <div class="f fc gap8 f_200">
                        ...
                        <div class="w f fc">
                            <input type="text" name="tab_3_stick_1" list="tab_3_stick_1" id="tab_3_stick_1_selected" placeholder="Оберіть вставку" class="shadow pad8"/>
                ...
                <div class="f gap8 fac shadow pad4 _br8 f_250">
                    ...
                    <div class="f fc gap8 f_200">
                        ...
                        <div class="w f fc">
                            <input type="text" name="tab_3_stick_2" list="tab_3_stick_2" id="tab_3_stick_2_selected" placeholder="Оберіть виїмку" class="shadow pad8"/>
            ...
            <div class="f fw gap20 f_f f_512">
                <div class="f gap8 fac shadow pad4 _br8 f_250">
                    ...
                    <div class="f fc gap8 f_200">
                        ...
                        <div class="w f fc">
                            <input type="text" name="tab_3_stick_3" list="tab_3_stick_3" id="tab_3_stick_3_selected" placeholder="Оберіть виїмку" class="shadow pad8"/>
                ...
                <div class="f gap8 fac shadow pad4 _br8 f_250">
                    ...
                    <div class="f fc gap8 f_200">
                        ...
                        <div class="w f fc">
                            <input type="text" name="tab_3_stick_4" id="tab_3_stick_4_selected" placeholder="індівідуальна" class="shadow pad8" oninput="addNumber('tab_3_stick_4','tab_3_stick_4_count')"/>
                        </div>
                    </div>
                    <!--К-сть-->
                    <div class="f fc gap8 f_100">
    ...
    <script>
        jQuery(function($) {
            $('.tab_3_buttons button').click(function(e) {
                ...
                var isGlassExists = $('datalist#tab_3_glass option').filter(function() {
                    return $(this).val().trim().toLowerCase() === enteredGlass;
                }).length > 0;

                if (!isGlassExists) {
                    alert('Оберіть посуд зі списку.');
                    return false;
                }
    ...
    <div class="f w fw gap20 list_stock">
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук посуду" id="tab_3_list_search" oninput="liveSearch('tab_3_list', this.value)">
        ...
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук вставки" id="tab_3_search_list_stick" oninput="liveSearch('tab_3_list_stick', this.value)">
...
<section id="tab_4" class="tabs__block f fc gap60">
    <form id="tab_4_form" class="f fw w gap8 f_f">
        <!--Стекло-->
        <div class="f fc gap8 f_200">
            <div class="w BIG">
                Посуд
            ...
            <div class="w f fc">
                <input type="text" name="tab_4_product" list="tab_4_product" id="tab_4_product_selected" placeholder="Оберіть посуд" class="shadow pad8" required/>
        ...
        <div class="f fc gap8 f_200">
            ...
            <div class="w f fc">
                <input type="text" name="tab_4_master" list="tab_4_master" placeholder="Оберіть фахівця" class="shadow pad8" required/>
    ...
    <script>
        jQuery(function($) {
            $('.tab_4_buttons button').click(function(e) {
                ...
                var isGlassExists = $('datalist#tab_4_product option').filter(function() {
                    return $(this).val().trim().toLowerCase() === enteredGlass;
                }).length > 0;
    ...
    <div class="f w fw gap20 list_stock">
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук посуду" id="tab_4_list_search" oninput="liveSearch('tab_4_list', this.value)">
...
<section id="tab_5" class="tabs__block f fc gap60">
    <form id="tab_5_form" class="f fw w gap8 f_f">
        <!--Стекло-->
        <div class="f fc gap8 f_200">
            <div class="w BIG">
                Продукт
            ...
            <div class="w f fc">
                <input type="text" name="tab_5_product" list="tab_5_product" id="tab_5_product_selected" placeholder="Оберіть скло" class="shadow pad8" required/>
        ...
        <div class="f fc gap8 f_200">
            ...
            <div class="w f fc">
                <input type="text" name="tab_5_master" list="tab_5_master" placeholder="Оберіть фахівця" class="shadow pad8" required/>
    ...
    <script>
        jQuery(function($) {
            $('.tab_5_buttons button').click(function(e) {
                ...
                var isGlassExists = $('datalist#tab_5_product option').filter(function() {
                    return $(this).val().trim().toLowerCase() === enteredGlass;
                }).length > 0;
    ...
    <div class="f w fw gap20 list_stock">
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук товару" id="tab_5_list_search" oninput="liveSearch('tab_5_list', this.value)">
...
<section id="tab_7" class="tabs__block f fc gap60">
    <div class="f w fw gap60">
        ...
        <!-- Скло -->
        <form action="" id="editing_glass_form" class="f fw w gap8 f_f">
            ...
            <div class="f fw w gap8 f_f f_600">
                ...
                <div class="f fc gap8 f_200">
                    ...
                    <div class="w f fc">
                        <input type="text" name="tab_7_glass_master" list="tab_7_glass_master" placeholder="Оберіть фахівця" class="shadow pad8" required/>
        ...
        <script>
            var glassList = <?php echo json_encode($glass_list); ?>;

            jQuery(function($) {
                $('.glass_buttons button').click(function(e) {
                    var action = $(this).attr('name'); // Получаем значение атрибута name нажатой кнопки
                    $('#glass_action').val(action); // Устанавливаем значение в скрытое поле

                    var enteredMaster = $('input[name="tab_7_glass_master"]').val().trim(); // Получаем значение выбранного специалиста
                    ...
                    if (action === 'Віднімання скла' || action === 'Додавання скла' || action === 'Видалення скла') {
                        var enteredGlass = $('input[name="tab_7_glass"]').val().trim(); // Получаем значение введенного стекла
                        ...
                        var enteredGlass = $('input[name="tab_7_glass"]').val().trim();
        ...
        <!-- Виїмка -->
        <form action="" id="editing_insert_form" class="f fw w gap8 f_f">
            <div class="f fw w gap8 f_f f_600">
                <!--Виемка-->
                <div class="f fc gap8 f_400">
                    ...
                    <div class="w f fc">
                        <input type="text" name="tab_7_insert" list="tab_7_insert" placeholder="Оберіть виїмку" class="shadow pad8" required/>
                ...
                <div class="f fc gap8 f_200">
                    ...
                    <div class="w f fc">
                        <input type="text" name="tab_7_insert_master" list="tab_7_insert_master" placeholder="Оберіть фахівця" class="shadow pad8" required/>
        ...
        <script>
            jQuery(function($) {
                $('.insert_buttons button').click(function(e) {
                    ...
                    var enteredMaster = $('input[name="tab_7_insert_master"]').val().trim(); // Получаем значение выбранного специалиста
                    ...
                    if (action === 'Видалення виїмки') {
                        var enteredInsert = $('input[name="tab_7_insert"]').val().trim(); // Получаем значение введенного стекла

                        var isInsertExists = false;
                        var enteredInsertLower = enteredInsert.toLowerCase(); // Приводим введенное значение стекла к нижнему регистру
                        $('datalist#tab_7_insert option').each(function() {
                            var currentInsertName = $(this).val().trim().toLowerCase(); // Приводим текущее значение стекла к нижнему регистру
                            if (currentInsertName === enteredInsertLower) {
                                isInsertExists = true;
                                return false; // Прерываем цикл, так как совпадение найдено
                            }
                        ...
                        if (!isInsertExists) {
                            ...
                            return false; // Завершаем обработчик
                                ...
                                // Ваш код для действия "Нове скло"
                                // Например, проверка на отсутствие стекла с таким же названием
                                var enteredInsert = $('input[name="tab_7_insert"]').val().trim();
                    ...
                    // Если все проверки успешно пройдены, отправляем данные формы
                    var formData = $('#editing_insert_form').serialize();
        ...
        <!-- Вставка -->
        <form action="" id="editing_stick_form" class="f fw w gap8 f_f">
            <div class="f fw w gap8 f_f f_600">
                <div class="f fw w gap8 f_f f_400">
                    <!--Вставки-->
                    <div class="f fc gap8 f_200">
                ...
                <div class="f fc gap8 f_200">
                    ...
                    <div class="w f fc">
                        <input type="text" name="tab_7_stick_master" list="tab_7_stick_master" placeholder="Оберіть фахівця" class="shadow pad8" required/>
        ...
        <script>
            var stickList = <?php echo json_encode($stick_list); ?>;
        ...
        <!-- Фахівець -->
        <form action="" id="editing_master_form" class="f fw w gap8 f_f">
            <div class="f fw w gap8 f_f f_600">
                <!--Специалист-->
                <div class="f fc gap8 f_400">
                    <div class="w BIG">
                    ...
                    <div class="w f fc">
                        <input type="text" name="tab_7_name" list="tab_7_name" placeholder="Оберіть фахівця" class="shadow pad8" required/>
                ...
                <div class="f fc gap8 f_200">
                    ...
                    <div class="w f fc">
                        <input type="text" name="tab_7_name_master" list="tab_7_name_master" placeholder="Оберіть фахівця" class="shadow pad8" required/>
        ...
        <script>
            jQuery(function($) {
                $('.masters_buttons button').click(function(e) {
                    ...
                    var enteredMaster = $('input[name="tab_7_name_master"]').val().trim(); // Получаем значение выбранного специалиста
                    ...
                    if (action === 'Створення фахівця') {
                        var enteredName = $('input[name="tab_7_name"]').val().trim(); // Получаем значение введенного имени
                        ...
                        var isNameExists = $('datalist#tab_7_name option[value="' + enteredName + '"]').length > 0;
                        ...
                        var enteredName = $('input[name="tab_7_name"]').val().trim(); // Получаем значение выбранного специалиста
    ...
    <div class="f w fw gap20 list_stock">
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук скла" id="tab_7_search_list_glass" oninput="liveSearch('tab_7_list_glass', this.value)">
        ...
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук виїмки" id="tab_7_search_list_insert" oninput="liveSearch('tab_7_list_insert', this.value)">
        ...
        <div class="f fc gap8 shadow pad8 _br8 f_300 h300M">
            ...
            <input type="text" name="" placeholder="Пошук вставки" id="tab_7_search_list_stick" oninput="liveSearch('tab_7_list_stick', this.value)">
